-- Pogled `match_assist_status` potrebuje še id-ja kluboma: stran z glasovanjem
-- iz `goals.team_id` ugotovi, čigav je gol, in ob njem pokaže pravi grb.
-- Nova stolpca sta na koncu, ker `create or replace view` vmesnih ne dovoli.
